 ...
 */
public interface ServoBase extends Component {

    //------------------------------------------------------------------------------------------------------------------
    // Limits
    //------------------------------------------------------------------------------------------------------------------
    float POS_MAX_LEFT = 0f; // Consider this to be the max. left position of an R/C-Radio stick
    float POS_NEUTRAL = 90f; // Consider this to be the neutral position of an R/C-Radio stick
    float POS_MAX_RIGHT = 180.0f; // Consider this to be the max. right position of an R/C-Radio stick
